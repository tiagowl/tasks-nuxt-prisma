declare global {
  ...
  const calculateTaskStatus: typeof import('../../server/utils/status').calculateTaskStatus
  const calculateTaskStatusSync: typeof import('../../server/utils/status').calculateTaskStatusSync
  ...
  const getTaskProgress: typeof import('../../server/utils/status').getTaskProgress
  ...
  const signJwt: typeof import('../../server/utils/jwt').signJwt
...
declare global {
  ...
  // @ts-ignore
  export type { TaskStatus, TaskProgress } from '../../server/utils/status'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/Tiago/Área de Trabalho/Projetos/tasks-nuxt-prisma/src/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/Tiago/Área de Trabalho/Projetos/tasks-nuxt-prisma/src/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { signJwt, verifyJwt } from 'D:/Tiago/Área de Trabalho/Projetos/tasks-nuxt-prisma/src/frontend/server/utils/jwt';
export { prisma } from 'D:/Tiago/Área de Trabalho/Projetos/tasks-nuxt-prisma/src/frontend/server/utils/prisma';
export { getTaskProgress, calculateTaskStatus, calculateTaskStatusSync } from 'D:/Tiago/Área de Trabalho/Projetos/tasks-nuxt-prisma/src/frontend/server/utils/status';